package com.qutalk.mall.core.system;

import com.qutalk.mall.core.util.SystemInfoPrinter;
...
class SystemInistService {
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.com.qutalk.mall.wx"));
