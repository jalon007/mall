package com.qutalk.mall.allinone;
...
//        System.out.println(environment.getProperty(""));
        ...
        System.out.println(environment.getProperty("logging.level.com.qutalk.mall.wx"));
        System.out.println(environment.getProperty("logging.level.com.qutalk.mall.admin"));
        System.out.println(environment.getProperty("logging.level.com.qutalk.mall"));
    }
