    ...
    <div class="container">
      <div class="siteinfo">
        <ul class="c0">
          <h3 class="c1">订单服务</h3>
          <ul>
            <li class="c2"><a class="c3" @click="open4">打赏方式</a></li>
            <li class="c2"><a class="c3" @click="open5">领券指南</a></li>
          </ul>
        </ul>
        <ul class="c0">
          <h3 class="c1">服务支持</h3>
        ...
        <ul class="c0">
          <h3 class="c1">自助服务</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" href="http://blog.jalon.xyz">个人博客</a></li>
        ...
        <ul class="c0">
          <h3 class="c1">友情链接</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" href="http://blog.jalon.xyz/">JalonBlog</a></li>
  ...
  export default {
    ...
    methods: {
      ...
      open4 () {
        this.$notify.info({
          title: '打赏方式',
          message: '微信、支持支付宝等方式捐赠'
        })
      },
      open5 () {
        this.$notify({
          title: '领券指南',
          message: '本网站只推荐购买优惠券、请到对应平台购买商品、本网站暂不售卖任何商品、不对商品质量及交易方式负责',
          type: 'warning'
        })
      }
    },
