  ...
  <div class="brands w">
    <div class="brands-center" v-loading="loading" element-loading-text="加载中..." style="min-height: 35vw;">
      <div class="brand-left">
        <notion :title="notions[0]" :notions="topics" :index="5"></notion>
      </div>
      <div class="brand-item" v-if="!noResult">
        <!--商品-->
        <div class="brands-box">
          <topic-mall v-for="(item,i) in topics" :key="i" :msg="item"></topic-mall>
        </div>
...
<script>
  import { getTopicList } from '/api/goods.js'
  import { recommend } from '/api/index.js'
  import topicMall from '/components/topicMall'
